#!/usr/bin/env python3
"""Start a dedicated Hyphae instance for the amyloidosis corpus."""
import os
import sys
...
DB_PATH = os.path.expanduser("~/.hyphae/amyloidosis.db")
PORT = 8101
...
_instance = None
def get_amyloidosis_hyphae():
    global _instance
    if _instance is None:
        _instance = hyphae.Hyphae(db_path=DB_PATH)
    return _instance

server_module.get_hyphae = get_amyloidosis_hyphae

if __name__ == "__main__":
    import uvicorn
    print(f"Starting Amyloidosis Hyphae on port {PORT}")
