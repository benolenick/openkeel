...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.policy = RoutingPolicy.load()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        self.preset_combo.setCurrentText(self.policy.preset)
        ...
        self.desc_label = QLabel(descriptions.get(self.policy.preset, ""))
        ...
        for i, (band, key) in enumerate(zip(bands, band_keys)):
            ...
            model = self.policy.models.get(key, "unknown")
    ...
    def on_preset_changed(self, preset_name):
        ...
        self.policy = RoutingPolicy.get_preset(preset_name)
        band_keys = ["band_a", "band_b", "band_c", "band_d", "judge"]
